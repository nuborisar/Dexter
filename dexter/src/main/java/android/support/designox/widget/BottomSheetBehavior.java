...
import android.support.v4ox.view.VelocityTrackerCompat;
import android.support.v4ox.view.ViewCompat;
import android.support.v4ox.widget.ViewDragHelper;
...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
     ...
     * @attr ref android.support.designox.R.styleable#BottomSheetBehavior_Params_behavior_peekHeight
     */
     ...
     * @attr ref android.support.designox.R.styleable#BottomSheetBehavior_Params_behavior_hideable
     */
