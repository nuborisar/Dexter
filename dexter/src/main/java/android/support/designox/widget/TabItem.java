 ...
 * to use it.
 *
 * @attr ref android.support.designox.R.styleable#TabItem_android_icon
 * @attr ref android.support.designox.R.styleable#TabItem_android_text
 * @attr ref android.support.designox.R.styleable#TabItem_android_layout
 *
 * @see TabLayout
 */
