...
public class AppBarLayout extends LinearLayout {
     ...
     *                 be fully collapsed
     *
     * @attr ref android.support.designox.R.styleable#AppBarLayout_expanded
     */
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
         ...
         * @see #getScrollFlags()
         *
         * @attr ref android.support.designox.R.styleable#AppBarLayout_LayoutParams_layout_scrollFlags
         */
         ...
         *
         * @attr ref android.support.designox.R.styleable#AppBarLayout_LayoutParams_layout_scrollInterpolator
