...
import android.support.v4ox.view.NestedScrollingParent;
import android.support.v4ox.view.NestedScrollingParentHelper;
...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent {
    ...
    private class ApplyInsetsListener
            implements android.support.v4ox.view.OnApplyWindowInsetsListener {
        @Override
