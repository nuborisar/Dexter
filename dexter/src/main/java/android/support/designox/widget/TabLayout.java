...
import android.support.annotationox.ColorInt;
...
import android.support.v4ox.view.PagerAdapter;
import android.support.v4ox.view.ViewCompat;
import android.support.v4ox.view.ViewPager;
import android.support.v4ox.widget.TextViewCompat;
import android.support.v7ox.app.ActionBar;
import android.support.v7ox.widget.AppCompatDrawableManager;
...
import static android.support.v4ox.view.ViewPager.SCROLL_STATE_DRAGGING;
import static android.support.v4ox.view.ViewPager.SCROLL_STATE_IDLE;
import static android.support.v4ox.view.ViewPager.SCROLL_STATE_SETTLING;
 ...
 *
 * @attr ref android.support.designox.R.styleable#TabLayout_tabPadding
 * @attr ref android.support.designox.R.styleable#TabLayout_tabPaddingStart
 * @attr ref android.support.designox.R.styleable#TabLayout_tabPaddingTop
 * @attr ref android.support.designox.R.styleable#TabLayout_tabPaddingEnd
 * @attr ref android.support.designox.R.styleable#TabLayout_tabPaddingBottom
 * @attr ref android.support.designox.R.styleable#TabLayout_tabContentStart
 * @attr ref android.support.designox.R.styleable#TabLayout_tabBackground
 * @attr ref android.support.designox.R.styleable#TabLayout_tabMinWidth
 * @attr ref android.support.designox.R.styleable#TabLayout_tabMaxWidth
 * @attr ref android.support.designox.R.styleable#TabLayout_tabTextAppearance
 */
public class TabLayout extends HorizontalScrollView {
     ...
     *
     * @attr ref android.support.designox.R.styleable#TabLayout_tabIndicatorColor
     */
     ...
     *
     * @attr ref android.support.designox.R.styleable#TabLayout_tabIndicatorHeight
     */
    ...
    /**
     * Set the {@link android.support.designox.widget.TabLayout.OnTabSelectedListener} that will
     ...
     *
     * @attr ref android.support.designox.R.styleable#TabLayout_tabMode
     */
     ...
     *
     * @attr ref android.support.designox.R.styleable#TabLayout_tabGravity
     */
     ...
     * Sets the text colors for the different states (normal, selected) used for the tabs.
     *
     * @attr ref android.support.designox.R.styleable#TabLayout_tabTextColor
     * @attr ref android.support.designox.R.styleable#TabLayout_tabSelectedTextColor
     */
